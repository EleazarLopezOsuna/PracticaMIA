...
SELECT Hospital.nombre, Tipo_Contacto.nombre, COUNT(Tipo_Contacto.nombre) AS Numero FROM Tipo_Contacto, Victima, Contacto, Relacion, Hospital, Ficha_Medica WHERE Victima.id_victima = Relacion.id_victima AND Relacion.id_relacion = Contacto.id_relacion AND Contacto.id_tipo_contacto = Tipo_Contacto.id_tipo_contacto AND Victima.id_victima = Ficha_Medica.id_victima AND Hospital.id_hospital = Ficha_Medica.id_hospital GROUP BY Hospital.nombre, Tipo_Contacto.nombre ORDER BY Hospital.nombre, Numero DESC;
