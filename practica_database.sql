DROP SCHEMA IF EXISTS practica_GVE ;
CREATE SCHEMA  practica_GVE DEFAULT CHARACTER SET utf8 ;
USE practica_GVE ;
...
CREATE TABLE practica_GVE.Tratamiento (
...
CREATE TABLE practica_GVE.Estatus (
...
CREATE TABLE practica_GVE.Asociado (
...
CREATE TABLE practica_GVE.Tipo_Contacto (
...
CREATE TABLE practica_GVE.Hospital (
...
CREATE TABLE practica_GVE.Victima (
  ...
  INDEX fk_Victima_Estatus_idx (id_estatus ASC) VISIBLE,
  CONSTRAINT fk_Victima_Estatus
...
CREATE TABLE practica_GVE.Relacion (
  id_relacion INT NOT NULL AUTO_INCREMENT,
  id_victima INT NOT NULL,
  id_asociado INT NOT NULL,
  fecha_inicio DATETIME NOT NULL,
  PRIMARY KEY (id_relacion, id_asociado, id_victima),
...
CREATE TABLE practica_GVE.Contacto (
  ...
  INDEX fk_Contacto_Relacion1_idx (id_relacion ASC, id_asociado ASC, id_victima ASC) VISIBLE,
  INDEX fk_Contacto_Tipo_Contacto1_idx (id_tipo_contacto ASC) VISIBLE,
  CONSTRAINT fk_Contacto_Relacion1
    FOREIGN KEY (id_relacion , id_asociado , id_victima)
    REFERENCES practica_GVE.Relacion (id_relacion , id_asociado , id_victima)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE practica_GVE.Localizacion (
...
CREATE TABLE practica_GVE.Proceso_Recuperacion (
  ...
  INDEX fk_Proceso_Recuperacion_Ficha_Medica1_idx (id_ficha_medica ASC, id_victima ASC, id_hospital ASC) VISIBLE,
  ...
  CONSTRAINT fk_Proceso_Recuperacion_Ficha_Medica1
    FOREIGN KEY (id_ficha_medica , id_victima , id_hospital)
    REFERENCES practica_GVE.Ficha_Medica (id_ficha_medica , id_victima , id_hospital)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
